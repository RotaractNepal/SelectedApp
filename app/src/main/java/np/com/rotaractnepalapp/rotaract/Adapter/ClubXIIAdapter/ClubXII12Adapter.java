...
public class ClubXII12Adapter extends RecyclerView.Adapter<ClubXII12Adapter.ClubViewHolder> {

    ArrayList<ClubXII12Class> data = new ArrayList<>();

    public ClubXII12Adapter(ArrayList<ClubXII12Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII12Class clickedDataItem = data.get(position);
