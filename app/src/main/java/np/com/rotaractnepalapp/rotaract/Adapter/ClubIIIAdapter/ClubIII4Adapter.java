...
public class ClubIII4Adapter extends RecyclerView.Adapter<ClubIII4Adapter.ClubViewHolder> {

    ArrayList<ClubIII4Class> data = new ArrayList<>();

    public ClubIII4Adapter(ArrayList<ClubIII4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIII4Class clickedDataItem = data.get(position);
