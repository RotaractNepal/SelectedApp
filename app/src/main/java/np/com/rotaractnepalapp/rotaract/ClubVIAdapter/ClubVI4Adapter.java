...
public class ClubVI4Adapter extends RecyclerView.Adapter<ClubVI4Adapter.ClubViewHolder>{

    ArrayList<ClubVI4Class> data = new ArrayList<>();

    public ClubVI4Adapter(ArrayList<ClubVI4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI4Class clickedDataItem = data.get(position);
