...
public class ClubIV10Adapter extends RecyclerView.Adapter<ClubIV10Adapter.ClubViewHolder> {

    ArrayList<ClubIV10Class> data = new ArrayList<>();

    public ClubIV10Adapter(ArrayList<ClubIV10Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV10Class clickedDataItem = data.get(position);
