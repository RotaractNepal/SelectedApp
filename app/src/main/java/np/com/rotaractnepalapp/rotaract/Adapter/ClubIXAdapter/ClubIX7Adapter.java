...
public class ClubIX7Adapter extends RecyclerView.Adapter<ClubIX7Adapter.ClubViewHolder> {

     ArrayList<ClubIX7Class> data = new ArrayList<>();

    public ClubIX7Adapter(ArrayList<ClubIX7Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX7Class clickedDataItem = data.get(position);
