...
public class ClubVI9Adapter extends RecyclerView.Adapter<ClubVI9Adapter.ClubViewHolder> {

    ArrayList<ClubVI9Class> data = new ArrayList<>();

    public ClubVI9Adapter(ArrayList<ClubVI9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI9Class clickedDataItem = data.get(position);
