...
public class ClubVI13Adapter extends RecyclerView.Adapter<ClubVI13Adapter.ClubViewHolder> {

    ArrayList<ClubVI13Class> data = new ArrayList<>();

    public ClubVI13Adapter(ArrayList<ClubVI13Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI13Class clickedDataItem = data.get(position);
