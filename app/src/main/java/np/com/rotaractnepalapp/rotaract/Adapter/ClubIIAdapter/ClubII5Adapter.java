...
public class ClubII5Adapter extends RecyclerView.Adapter<ClubII5Adapter.ClubViewHolder> {

    ArrayList<ClubII5Class> data = new ArrayList<>();

    public ClubII5Adapter(ArrayList<ClubII5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubII5Class clickedDataItem = data.get(position);
