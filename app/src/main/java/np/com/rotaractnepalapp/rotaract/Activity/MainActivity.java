...
public class MainActivity extends AppCompatActivity
    ...
    public static ArrayList<Intro5Class> getIntro5Data(){
        ...
        intro5Classes.add(new Intro5Class(R.mipmap.ic_ryla, R.mipmap.ic_ryla,"RYLA", "Rotary Youth Leadership Awards (RYLA) is an intensive leadership experience organized by Rotary clubs and districts where you develop your skills as a leader while having fun and making connections." +
