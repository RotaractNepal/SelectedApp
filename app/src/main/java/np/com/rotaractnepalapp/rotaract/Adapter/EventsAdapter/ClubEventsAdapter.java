...
public class ClubEventsAdapter extends RecyclerView.Adapter<ClubEventsAdapter.EventsViewHolder> {

    ArrayList<ClubEventsClass> data = new ArrayList<>();

    public ClubEventsAdapter(ArrayList<ClubEventsClass> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubEventsClass clickedDataItem = data.get(position);
