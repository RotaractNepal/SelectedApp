...
public class ClubVI2Adapter extends RecyclerView.Adapter<ClubVI2Adapter.ClubViewHolder> {

    ArrayList<ClubVI2Class> data = new ArrayList<>();

    public ClubVI2Adapter(ArrayList<ClubVI2Class> data) {
        this.data = data;
    }

    @NonNull
    @Override
    public ClubVI2Adapter.ClubViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itemadapter, viewGroup, false);
        return new ClubViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ClubVI2Adapter.ClubViewHolder clubViewHolder, int i) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI2Class clickedDataItem = data.get(position);
