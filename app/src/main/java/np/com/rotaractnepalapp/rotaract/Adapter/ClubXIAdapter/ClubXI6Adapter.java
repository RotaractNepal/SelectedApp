...
public class ClubXI6Adapter extends RecyclerView.Adapter<ClubXI6Adapter.ClubViewHolder> {

    ArrayList<ClubXI6Class> data = new ArrayList<>();

    public ClubXI6Adapter(ArrayList<ClubXI6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI6Class clickedDataItem = data.get(position);
