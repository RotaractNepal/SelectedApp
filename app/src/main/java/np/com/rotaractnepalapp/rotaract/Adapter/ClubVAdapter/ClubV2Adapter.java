...
public class ClubV2Adapter extends RecyclerView.Adapter<ClubV2Adapter.ClubViewHolder> {

    ArrayList<ClubV2Class> data = new ArrayList<>();

    public ClubV2Adapter(ArrayList<ClubV2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV2Class clickedDataItem = data.get(position);
