...
public class Intro4Adpater extends RecyclerView.Adapter<Intro4Adpater.ClubViewHolder> {

    ArrayList<Intro4Class> data = new ArrayList<>();

    public Intro4Adpater(ArrayList<Intro4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final Intro4Class clickedDataItem = data.get(position);
