...
public class ClubIV1Adapter extends RecyclerView.Adapter<ClubIV1Adapter.ClubViewHolder> {

    ArrayList<ClubIV1Class> data = new ArrayList<>();

    public ClubIV1Adapter(ArrayList<ClubIV1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV1Class clickedDataItem = data.get(position);
