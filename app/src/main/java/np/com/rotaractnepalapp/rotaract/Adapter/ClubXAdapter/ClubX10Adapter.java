...
public class ClubX10Adapter extends RecyclerView.Adapter<ClubX10Adapter.ClubViewHolder> {

    ArrayList<ClubX10Class> data = new ArrayList<>();

    public ClubX10Adapter(ArrayList<ClubX10Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX10Class clickedDataItem = data.get(position);
