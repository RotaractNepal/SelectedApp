...
public class ClubVI3Adapter extends RecyclerView.Adapter<ClubVI3Adapter.ClubViewHolder>{

    ArrayList<ClubVI3Class> data = new ArrayList<>();

    public ClubVI3Adapter(ArrayList<ClubVI3Class> data){
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI3Class clickedDataItem = data.get(position);
