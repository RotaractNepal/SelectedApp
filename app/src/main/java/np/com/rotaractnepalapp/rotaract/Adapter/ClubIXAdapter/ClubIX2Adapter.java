...
public class ClubIX2Adapter extends RecyclerView.Adapter<ClubIX2Adapter.ClubViewHolder> {

    ArrayList<ClubIX2Class> data = new ArrayList<>();

    public ClubIX2Adapter(ArrayList<ClubIX2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX2Class clickedDataItem = data.get(position);
