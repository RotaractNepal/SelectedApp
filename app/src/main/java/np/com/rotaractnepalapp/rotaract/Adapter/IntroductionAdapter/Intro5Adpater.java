...
public class Intro5Adpater extends RecyclerView.Adapter<Intro5Adpater.ClubViewHolder> {

    ArrayList<Intro5Class> data = new ArrayList<>();

    public Intro5Adpater(ArrayList<Intro5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final Intro5Class clickedDataItem = data.get(position);
