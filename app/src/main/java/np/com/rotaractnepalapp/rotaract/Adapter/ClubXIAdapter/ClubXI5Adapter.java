...
public class ClubXI5Adapter extends RecyclerView.Adapter<ClubXI5Adapter.ClubViewHolder> {

    ArrayList<ClubXI5Class> data = new ArrayList<>();

    public ClubXI5Adapter(ArrayList<ClubXI5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI5Class clickedDataItem = data.get(position);
