...
public class ClubI5Adapter extends RecyclerView.Adapter<ClubI5Adapter.ClubViewHolder> {

    ArrayList<ClubI5Class> data = new ArrayList<>();

    public ClubI5Adapter(ArrayList<ClubI5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubI5Class clickedDataItem = data.get(position);
