...
public class ClubVI5Adapter extends RecyclerView.Adapter<ClubVI5Adapter.ClubViewHolder> {

    ArrayList<ClubVI5Class> data = new ArrayList<>();

    public ClubVI5Adapter(ArrayList<ClubVI5Class> data) {
        this.data = data;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final ClubViewHolder clubViewHolder, final int i) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI5Class clickedDataItem = data.get(position);
