...
public class ClubIV5Adapter extends RecyclerView.Adapter<ClubIV5Adapter.ClubViewHolder> {

    ArrayList<ClubIV5Class> data = new ArrayList<>();

    public ClubIV5Adapter(ArrayList<ClubIV5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV5Class clickedDataItem = data.get(position);
