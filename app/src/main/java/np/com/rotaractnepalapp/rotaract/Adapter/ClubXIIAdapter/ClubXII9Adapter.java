...
public class ClubXII9Adapter extends RecyclerView.Adapter<ClubXII9Adapter.ClubViewHolder> {

    ArrayList<ClubXII9Class> data = new ArrayList<>();

    public ClubXII9Adapter(ArrayList<ClubXII9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII9Class clickedDataItem = data.get(position);
