...
public class ClubXII7Class {
    ...
    public ClubXII7Class() {
    }

    public ClubXII7Class(int images, String title, int bimages, String name, String ridno, String call, String email) {
        this.images = images;
        this.title = title;
