...
public class ClubXII6Class {
    ...
    public ClubXII6Class() {
    }

    public ClubXII6Class(int images, String title, int bimages, String name, String ridno, String call, String email) {
        this.images = images;
        this.title = title;
