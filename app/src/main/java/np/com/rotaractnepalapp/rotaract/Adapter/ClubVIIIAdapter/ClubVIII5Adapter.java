...
public class ClubVIII5Adapter extends RecyclerView.Adapter<ClubVIII5Adapter.ClubViewHolder> {

    ArrayList<ClubVIII5Class> data = new ArrayList<>();

    public ClubVIII5Adapter(ArrayList<ClubVIII5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVIII5Class clickedDataItem = data.get(position);
