...
public class ClubXII2Adapter extends RecyclerView.Adapter<ClubXII2Adapter.ClubViewHolder> {

    ArrayList<ClubXII2Class> data = new ArrayList<>();

    public ClubXII2Adapter(ArrayList<ClubXII2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII2Class clickedDataItem = data.get(position);
