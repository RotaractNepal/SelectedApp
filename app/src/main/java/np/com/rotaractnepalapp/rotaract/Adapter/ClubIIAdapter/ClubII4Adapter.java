...
public class ClubII4Adapter extends RecyclerView.Adapter<ClubII4Adapter.ClubViewHolder> {

    ArrayList<ClubII4Class> data = new ArrayList<>();

    public ClubII4Adapter(ArrayList<ClubII4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubII4Class clickedDataItem = data.get(position);
