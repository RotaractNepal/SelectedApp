...
public class ClubIII5Adapter extends RecyclerView.Adapter<ClubIII5Adapter.ClubViewHolder> {

    ArrayList<ClubIII5Class> data = new ArrayList<>();

    public ClubIII5Adapter(ArrayList<ClubIII5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIII5Class clickedDataItem = data.get(position);
