...
public class ClubVI8Adapter extends RecyclerView.Adapter<ClubVI8Adapter.ClubViewHolder> {

    ArrayList<ClubVI8Class> data = new ArrayList<>();

    public ClubVI8Adapter(ArrayList<ClubVI8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI8Class clickedDataItem = data.get(position);
