...
public class Club12Adapter extends RecyclerView.Adapter<Club12Adapter.ClubViewHolder> {

    ArrayList<Club12Class> data = new ArrayList<>();

    public Club12Adapter(ArrayList<Club12Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final Club12Class clickedDataItem = data.get(position);
