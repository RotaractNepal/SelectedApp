...
public class ClubIV4Adapter extends RecyclerView.Adapter<ClubIV4Adapter.ClubViewHolder> {

    ArrayList<ClubIV4Class> data = new ArrayList<>();

    public ClubIV4Adapter(ArrayList<ClubIV4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV4Class clickedDataItem = data.get(position);
