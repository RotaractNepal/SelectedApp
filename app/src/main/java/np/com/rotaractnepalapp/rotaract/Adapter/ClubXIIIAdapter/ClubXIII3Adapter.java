...
public class ClubXIII3Adapter extends RecyclerView.Adapter<ClubXIII3Adapter.ClubViewHolder> {

    ArrayList<ClubXIII3Class> data = new ArrayList<>();

    public ClubXIII3Adapter(ArrayList<ClubXIII3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXIII3Class clickedDataItem = data.get(position);
