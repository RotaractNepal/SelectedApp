...
public class ClubIX5Adapter extends RecyclerView.Adapter<ClubIX5Adapter.ClubViewHolder> {

    ArrayList<ClubIX5Class> data = new ArrayList<>();

    public ClubIX5Adapter(ArrayList<ClubIX5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX5Class clickedDataItem = data.get(position);
