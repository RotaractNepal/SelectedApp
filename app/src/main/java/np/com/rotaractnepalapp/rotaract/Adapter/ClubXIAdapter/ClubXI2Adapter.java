...
public class ClubXI2Adapter extends RecyclerView.Adapter<ClubXI2Adapter.ClubViewHolder> {

    ArrayList<ClubXI2Class> data = new ArrayList<>();

    public ClubXI2Adapter(ArrayList<ClubXI2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI2Class clickedDataItem = data.get(position);
