...
public class ClubXII10Adapter extends RecyclerView.Adapter<ClubXII10Adapter.ClubViewHolder> {

    ArrayList<ClubXII10Class> data = new ArrayList<>();

    public ClubXII10Adapter(ArrayList<ClubXII10Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII10Class clickedDataItem = data.get(position);
