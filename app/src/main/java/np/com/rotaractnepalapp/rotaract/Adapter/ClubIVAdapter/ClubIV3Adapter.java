...
public class ClubIV3Adapter extends RecyclerView.Adapter<ClubIV3Adapter.ClubViewHolder> {

    ArrayList<ClubIV3Class> data = new ArrayList<>();

    public ClubIV3Adapter(ArrayList<ClubIV3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV3Class clickedDataItem = data.get(position);
