...
public class ClubI8Adapter extends RecyclerView.Adapter<ClubI8Adapter.ClubViewHolder> {

    ArrayList<ClubI8Class> data = new ArrayList<>();

    public ClubI8Adapter(ArrayList<ClubI8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubI8Class clickedDataItem = data.get(position);
