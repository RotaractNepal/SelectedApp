...
public class ClubVII4Adapter extends RecyclerView.Adapter<ClubVII4Adapter.ClubViewHolder> {

    ArrayList<ClubVII4Class> data = new ArrayList<>();

    public ClubVII4Adapter(ArrayList<ClubVII4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII4Class clickedDataItem = data.get(position);
