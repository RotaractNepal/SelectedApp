...
public class ClubX3Adapter extends RecyclerView.Adapter<ClubX3Adapter.ClubViewHolder> {

    ArrayList<ClubX3Class> data = new ArrayList<>();

    public ClubX3Adapter(ArrayList<ClubX3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX3Class clickedDataItem = data.get(position);
