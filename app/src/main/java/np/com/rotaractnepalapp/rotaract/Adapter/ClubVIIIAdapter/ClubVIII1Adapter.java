...
public class ClubVIII1Adapter extends RecyclerView.Adapter<ClubVIII1Adapter.ClubViewHolder> {

    ArrayList<ClubVIII1Class> data = new ArrayList<>();

    public ClubVIII1Adapter(ArrayList<ClubVIII1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVIII1Class clickedDataItem = data.get(position);
