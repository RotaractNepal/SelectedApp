...
public class BloodGroupAdapter extends RecyclerView.Adapter<BloodGroupAdapter.BloodGroupViewHolder> {
    ...
    public BloodGroupAdapter(ArrayList<BloodGroupClass> bloodGroupClasses) {
    ...
    public BloodGroupViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.blood_group_item_adapter, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull BloodGroupViewHolder bloodGroupViewHolder, int i) {
        ...
        bloodGroupViewHolder.clubshortname.setText(bloodGroupClass.getClubshortname());
    ...
    public void filterList(ArrayList<BloodGroupClass> filteredList){
        bloodGroupClasses = filteredList;
        notifyDataSetChanged();
    }

    public class BloodGroupViewHolder extends RecyclerView.ViewHolder {
        TextView bloodgroup, name, clubname, address, clubshortname;
        ...
        public BloodGroupViewHolder(@NonNull View itemView) {
            ...
            clubshortname = (TextView) itemView.findViewById(R.id.bloodDonorClubSortName);
