...
public class ClubIII3Adapter extends RecyclerView.Adapter<ClubIII3Adapter.ClubViewHolder> {

    ArrayList<ClubIII3Class> data = new ArrayList<>();

    public ClubIII3Adapter(ArrayList<ClubIII3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIII3Class clickedDataItem = data.get(position);
