...
public class ClubVI11Adapter extends RecyclerView.Adapter<ClubVI11Adapter.ClubViewHolder> {

    ArrayList<ClubVI11Class> data = new ArrayList<>();

    public ClubVI11Adapter(ArrayList<ClubVI11Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI11Class clickedDataItem = data.get(position);
