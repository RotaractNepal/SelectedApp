...
public class ClubIV11Adapter extends RecyclerView.Adapter<ClubIV11Adapter.ClubViewHolder> {

    ArrayList<ClubIV11Class> data = new ArrayList<>();

    public ClubIV11Adapter(ArrayList<ClubIV11Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV11Class clickedDataItem = data.get(position);
