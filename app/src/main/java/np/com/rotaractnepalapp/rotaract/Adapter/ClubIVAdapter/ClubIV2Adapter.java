...
public class ClubIV2Adapter extends RecyclerView.Adapter<ClubIV2Adapter.ClubViewHolder> {

    ArrayList<ClubIV2Class> data = new ArrayList<>();

    public ClubIV2Adapter(ArrayList<ClubIV2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV2Class clickedDataItem = data.get(position);
