...
public class ClubXII4Adapter extends RecyclerView.Adapter<ClubXII4Adapter.ClubViewHolder> {

    ArrayList<ClubXII4Class> data = new ArrayList<>();

    public ClubXII4Adapter(ArrayList<ClubXII4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII4Class clickedDataItem = data.get(position);
