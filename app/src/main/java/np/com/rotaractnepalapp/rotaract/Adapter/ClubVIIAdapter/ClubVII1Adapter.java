...
public class ClubVII1Adapter extends RecyclerView.Adapter<ClubVII1Adapter.ClubViewHolder> {

    ArrayList<ClubVII1Class> data = new ArrayList<>();

    public ClubVII1Adapter(ArrayList<ClubVII1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII1Class clickedDataItem = data.get(position);
