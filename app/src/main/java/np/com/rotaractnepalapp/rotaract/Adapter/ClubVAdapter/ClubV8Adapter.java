...
public class ClubV8Adapter extends RecyclerView.Adapter<ClubV8Adapter.ClubViewHolder> {

    ArrayList<ClubV8Class> data = new ArrayList<>();

    public ClubV8Adapter(ArrayList<ClubV8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV8Class clickedDataItem = data.get(position);
