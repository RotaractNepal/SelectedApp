...
public class ClubVII8Adapter extends RecyclerView.Adapter<ClubVII8Adapter.ClubViewHolder> {

    ArrayList<ClubVII8Class> data = new ArrayList<>();

    public ClubVII8Adapter(ArrayList<ClubVII8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII8Class clickedDataItem = data.get(position);
