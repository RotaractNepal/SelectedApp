...
public class ClubIV6Adapter extends RecyclerView.Adapter<ClubIV6Adapter.ClubViewHolder> {

    ArrayList<ClubIV6Class> data = new ArrayList<>();

    public ClubIV6Adapter(ArrayList<ClubIV6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV6Class clickedDataItem = data.get(position);
