...
public class ClubVIII8Adapter extends RecyclerView.Adapter<ClubVIII8Adapter.ClubViewHolder> {

    ArrayList<ClubVIII8Class> data = new ArrayList<>();

    public ClubVIII8Adapter(ArrayList<ClubVIII8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVIII8Class clickedDataItem = data.get(position);
