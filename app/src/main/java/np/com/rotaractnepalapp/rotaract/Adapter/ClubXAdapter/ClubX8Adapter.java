...
public class ClubX8Adapter extends RecyclerView.Adapter<ClubX8Adapter.ClubViewHolder> {

    ArrayList<ClubX8Class> data = new ArrayList<>();

    public ClubX8Adapter(ArrayList<ClubX8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX8Class clickedDataItem = data.get(position);
