...
public class ClubXII1Class {
    ...
    public ClubXII1Class() {
    }

    public ClubXII1Class(int images, String title, int bimages, String name, String ridno, String call, String email) {
        this.images = images;
        this.title = title;
