...
public class ClubIII2Adapter extends RecyclerView.Adapter<ClubIII2Adapter.ClubViewHolder> {

    ArrayList<ClubIII2Class> data = new ArrayList<>();

    public ClubIII2Adapter(ArrayList<ClubIII2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIII2Class clickedDataItem = data.get(position);
