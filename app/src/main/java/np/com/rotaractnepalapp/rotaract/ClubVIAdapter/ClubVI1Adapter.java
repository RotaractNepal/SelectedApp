...
public class ClubVI1Adapter extends RecyclerView.Adapter<ClubVI1Adapter.ClubViewHolder> {

    ArrayList<ClubVI1Class> data = new ArrayList<>();

    public ClubVI1Adapter(ArrayList<ClubVI1Class> data){
        this.data = data;
    }

    @NonNull
    @Override
    public ClubVI1Adapter.ClubViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.itemadapter, viewGroup, false);
        return new ClubViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ClubVI1Adapter.ClubViewHolder clubViewHolder, int i) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI1Class clickedDataItem = data.get(position);
