...
public class ClubI2Adapter extends RecyclerView.Adapter<ClubI2Adapter.ClubViewHolder> {

    ArrayList<ClubI2Class> data = new ArrayList<>();

    public ClubI2Adapter(ArrayList<ClubI2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubI2Class clickedDataItem = data.get(position);
