...
public class ClubV13Adapter extends RecyclerView.Adapter<ClubV13Adapter.ClubViewHolder> {

    ArrayList<ClubV13Class> data = new ArrayList<>();

    public ClubV13Adapter(ArrayList<ClubV13Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV13Class clickedDataItem = data.get(position);
