...
public class Club11Adapter extends RecyclerView.Adapter<Club11Adapter.ClubViewHolder> {

    ArrayList<Club11Class> data = new ArrayList<>();

    public Club11Adapter(ArrayList<Club11Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final Club11Class clickedDataItem = data.get(position);
