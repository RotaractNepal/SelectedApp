...
public class ClubXII2Class {
    ...
    public ClubXII2Class() {
    }

    public ClubXII2Class(int images, String title, int bimages, String name, String ridno, String call, String email) {
        this.images = images;
        this.title = title;
