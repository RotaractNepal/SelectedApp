...
public class ClubV7Adapter extends RecyclerView.Adapter<ClubV7Adapter.ClubViewHolder> {

    ArrayList<ClubV7Class> data = new ArrayList<>();

    public ClubV7Adapter(ArrayList<ClubV7Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV7Class clickedDataItem = data.get(position);
