...
public class ClubIX3Adapter extends RecyclerView.Adapter<ClubIX3Adapter.ClubViewHolder> {

    ArrayList<ClubIX3Class> data = new ArrayList<>();

    public ClubIX3Adapter(ArrayList<ClubIX3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX3Class clickedDataItem = data.get(position);
