...
public class ClubI9Adapter extends RecyclerView.Adapter<ClubI9Adapter.ClubViewHolder> {

    ArrayList<ClubI9Class> data = new ArrayList<>();

    public ClubI9Adapter(ArrayList<ClubI9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubI9Class clickedDataItem = data.get(position);
