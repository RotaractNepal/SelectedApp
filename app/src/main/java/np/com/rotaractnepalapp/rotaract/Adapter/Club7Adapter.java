...
public class Club7Adapter extends RecyclerView.Adapter<Club7Adapter.ClubViewHolder> {

    ArrayList<Club7Class> data = new ArrayList<>();

    public Club7Adapter(ArrayList<Club7Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final Club7Class clickedDataItem = data.get(position);
