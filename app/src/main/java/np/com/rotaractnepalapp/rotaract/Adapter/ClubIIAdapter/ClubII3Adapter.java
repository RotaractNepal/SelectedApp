...
public class ClubII3Adapter extends RecyclerView.Adapter<ClubII3Adapter.ClubViewHolder> {

    ArrayList<ClubII3Class> data = new ArrayList<>();


    public ClubII3Adapter(ArrayList<ClubII3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubII3Class clickedDataItem = data.get(position);
