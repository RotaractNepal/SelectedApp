...
public class ClubV3Adapter extends RecyclerView.Adapter<ClubV3Adapter.ClubViewHolder> {

    ArrayList<ClubV3Class> data = new ArrayList<>();

    public ClubV3Adapter(ArrayList<ClubV3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV3Class clickedDataItem = data.get(position);
