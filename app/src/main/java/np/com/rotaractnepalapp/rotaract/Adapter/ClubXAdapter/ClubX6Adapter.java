...
public class ClubX6Adapter extends RecyclerView.Adapter<ClubX6Adapter.ClubViewHolder> {

    ArrayList<ClubX6Class> data = new ArrayList<>();

    public ClubX6Adapter(ArrayList<ClubX6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX6Class clickedDataItem = data.get(position);
