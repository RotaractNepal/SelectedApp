...
public class ClubXI11Adapter extends RecyclerView.Adapter<ClubXI11Adapter.ClubViewHolder> {

    ArrayList<ClubXI11Class> data = new ArrayList<>();

    public ClubXI11Adapter(ArrayList<ClubXI11Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI11Class clickedDataItem = data.get(position);
