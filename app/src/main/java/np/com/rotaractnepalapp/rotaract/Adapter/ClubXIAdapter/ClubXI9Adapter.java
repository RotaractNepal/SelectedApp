...
public class ClubXI9Adapter extends RecyclerView.Adapter<ClubXI9Adapter.ClubViewHolder> {

    ArrayList<ClubXI9Class> data = new ArrayList<>();

    public ClubXI9Adapter(ArrayList<ClubXI9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI9Class clickedDataItem = data.get(position);
