package np.com.rotaractnepalapp.rotaract.Adapter.ClubIIAdapter;
...
public class ClubII2Adapter extends RecyclerView.Adapter<ClubII2Adapter.ClubViewHolder> {

    ArrayList<ClubII2Class> data = new ArrayList<>();

    public ClubII2Adapter(ArrayList<ClubII2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubII2Class clickedDataItem = data.get(position);
