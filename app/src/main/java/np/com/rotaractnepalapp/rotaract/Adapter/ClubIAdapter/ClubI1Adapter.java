...
public class ClubI1Adapter extends RecyclerView.Adapter<ClubI1Adapter.ClubViewHolder> {

    ArrayList<ClubI1Class> data = new ArrayList<>();

    public ClubI1Adapter(ArrayList<ClubI1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubI1Class clickedDataItem = data.get(position);
