...
public class ClubIX4Adapter extends RecyclerView.Adapter<ClubIX4Adapter.ClubViewHolder> {

    ArrayList<ClubIX4Class> data = new ArrayList<>();

    public ClubIX4Adapter(ArrayList<ClubIX4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX4Class clickedDataItem = data.get(position);
