...
public class Club5Adapter extends RecyclerView.Adapter<Club5Adapter.ClubViewHolder> {

    ArrayList<Club5Class> data = new ArrayList<>();

    public Club5Adapter(ArrayList<Club5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final Club5Class clickedDataItem = data.get(position);
