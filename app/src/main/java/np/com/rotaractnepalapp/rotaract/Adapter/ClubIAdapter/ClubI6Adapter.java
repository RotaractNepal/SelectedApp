package np.com.rotaractnepalapp.rotaract.Adapter.ClubIAdapter;
...
public class ClubI6Adapter extends RecyclerView.Adapter<ClubI6Adapter.ClubViewHolder> {

    ArrayList<ClubI6Class> data = new ArrayList<>();

    public ClubI6Adapter(ArrayList<ClubI6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubI6Class clickedDataItem = data.get(position);
