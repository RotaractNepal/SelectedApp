...
public class ClubXII1Adapter extends RecyclerView.Adapter<ClubXII1Adapter.ClubViewHolder> {

    ArrayList<ClubXII1Class> data = new ArrayList<>();

    public ClubXII1Adapter(ArrayList<ClubXII1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII1Class clickedDataItem = data.get(position);
