...
public class ClubV6Adapter extends RecyclerView.Adapter<ClubV6Adapter.ClubViewHolder> {

    ArrayList<ClubV6Class> data = new ArrayList<>();

    public ClubV6Adapter(ArrayList<ClubV6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV6Class clickedDataItem = data.get(position);
