...
public class ClubIV7Adapter extends RecyclerView.Adapter<ClubIV7Adapter.ClubViewHolder> {

    ArrayList<ClubIV7Class> data = new ArrayList<>();

    public ClubIV7Adapter(ArrayList<ClubIV7Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV7Class clickedDataItem = data.get(position);
