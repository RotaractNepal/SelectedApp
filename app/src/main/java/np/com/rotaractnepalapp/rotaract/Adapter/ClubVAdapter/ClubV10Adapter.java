...
public class ClubV10Adapter extends RecyclerView.Adapter<ClubV10Adapter.ClubViewHolder> {

    ArrayList<ClubV10Class> data = new ArrayList<>();

    public ClubV10Adapter(ArrayList<ClubV10Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV10Class clickedDataItem = data.get(position);
