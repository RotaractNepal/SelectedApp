...
public class ClubIX6Adapter extends RecyclerView.Adapter<ClubIX6Adapter.ClubViewHolder> {

    ArrayList<ClubIX6Class> data = new ArrayList<>();

    public ClubIX6Adapter(ArrayList<ClubIX6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX6Class clickedDataItem = data.get(position);
