...
public class ClubVIII6Adapter extends RecyclerView.Adapter<ClubVIII6Adapter.ClubViewHolder> {

    ArrayList<ClubVIII6Class> data = new ArrayList<>();

    public ClubVIII6Adapter(ArrayList<ClubVIII6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVIII6Class clickedDataItem = data.get(position);
