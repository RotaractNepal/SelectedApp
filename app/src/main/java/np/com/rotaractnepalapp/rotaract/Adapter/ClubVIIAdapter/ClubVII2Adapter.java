...
public class ClubVII2Adapter extends RecyclerView.Adapter<ClubVII2Adapter.ClubViewHolder> {

    ArrayList<ClubVII2Class> data = new ArrayList<>();

    public ClubVII2Adapter(ArrayList<ClubVII2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII2Class clickedDataItem = data.get(position);
