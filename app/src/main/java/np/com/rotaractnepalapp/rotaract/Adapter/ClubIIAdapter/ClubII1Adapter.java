...
public class ClubII1Adapter extends RecyclerView.Adapter<ClubII1Adapter.ClubViewHolder> {

    ArrayList<ClubII1Class> data = new ArrayList<>();

    public ClubII1Adapter(ArrayList<ClubII1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubII1Class clickedDataItem = data.get(position);
