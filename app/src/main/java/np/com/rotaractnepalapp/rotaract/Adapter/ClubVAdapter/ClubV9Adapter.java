...
public class ClubV9Adapter extends RecyclerView.Adapter<ClubV9Adapter.ClubViewHolder> {

    ArrayList<ClubV9Class> data = new ArrayList<>();

    public ClubV9Adapter(ArrayList<ClubV9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV9Class clickedDataItem = data.get(position);
