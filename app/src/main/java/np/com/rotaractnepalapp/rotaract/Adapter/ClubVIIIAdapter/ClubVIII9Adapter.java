...
public class ClubVIII9Adapter extends RecyclerView.Adapter<ClubVIII9Adapter.ClubViewHolder> {

    ArrayList<ClubVIII9Class> data = new ArrayList<>();

    public ClubVIII9Adapter(ArrayList<ClubVIII9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVIII9Class clickedDataItem = data.get(position);
