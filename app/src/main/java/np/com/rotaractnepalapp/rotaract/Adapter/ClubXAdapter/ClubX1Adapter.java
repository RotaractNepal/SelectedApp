...
public class ClubX1Adapter extends RecyclerView.Adapter<ClubX1Adapter.ClubViewHolder> {

    ArrayList<ClubX1Class> data = new ArrayList<>();

    public ClubX1Adapter(ArrayList<ClubX1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX1Class clickedDataItem = data.get(position);
