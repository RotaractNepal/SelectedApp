...
public class ClubIX9Adapter extends RecyclerView.Adapter<ClubIX9Adapter.ClubViewHolder> {

    ArrayList<ClubIX9Class> data = new ArrayList<>();

    public ClubIX9Adapter(ArrayList<ClubIX9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX9Class clickedDataItem = data.get(position);
