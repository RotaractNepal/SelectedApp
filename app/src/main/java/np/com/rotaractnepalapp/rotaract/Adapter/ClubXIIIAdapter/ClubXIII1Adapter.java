...
public class ClubXIII1Adapter extends RecyclerView.Adapter<ClubXIII1Adapter.ClubViewHolder> {

    ArrayList<ClubXIII1Class> data = new ArrayList<>();

    public ClubXIII1Adapter(ArrayList<ClubXIII1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXIII1Class clickedDataItem = data.get(position);
