...
public class ClubVII5Adapter extends RecyclerView.Adapter<ClubVII5Adapter.ClubViewHolder> {

    ArrayList<ClubVII5Class> data = new ArrayList<>();

    public ClubVII5Adapter(ArrayList<ClubVII5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII5Class clickedDataItem = data.get(position);
