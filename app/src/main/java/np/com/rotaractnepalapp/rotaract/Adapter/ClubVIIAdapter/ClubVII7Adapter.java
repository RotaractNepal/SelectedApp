...
public class ClubVII7Adapter extends RecyclerView.Adapter<ClubVII7Adapter.ClubViewHolder> {

    ArrayList<ClubVII7Class> data = new ArrayList<>();

    public ClubVII7Adapter(ArrayList<ClubVII7Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII7Class clickedDataItem = data.get(position);
