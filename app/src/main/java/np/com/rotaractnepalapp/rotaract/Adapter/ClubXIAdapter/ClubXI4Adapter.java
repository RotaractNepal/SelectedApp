...
public class ClubXI4Adapter extends RecyclerView.Adapter<ClubXI4Adapter.ClubViewHolder> {

    ArrayList<ClubXI4Class> data = new ArrayList<>();

    public ClubXI4Adapter(ArrayList<ClubXI4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI4Class clickedDataItem = data.get(position);
