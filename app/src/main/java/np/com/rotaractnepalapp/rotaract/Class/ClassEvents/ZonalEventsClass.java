...
public class ZonalEventsClass {
    ...
    public ZonalEventsClass(String month, String day, String year, String organizer, String event, String venue, String time, String call, String googlemap, String eventdetail, String eventhighlights) {
        this.month = month;
        this.day = day;
        this.year = year;
