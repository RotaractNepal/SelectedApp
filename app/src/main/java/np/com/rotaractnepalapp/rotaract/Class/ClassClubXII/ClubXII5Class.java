...
public class ClubXII5Class {
    ...
    public ClubXII5Class() {
    }

    public ClubXII5Class(int images, String title, int bimages, String name, String ridno, String call, String email) {
        this.images = images;
        this.title = title;
