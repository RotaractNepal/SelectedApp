...
public class ClubX5Adapter extends RecyclerView.Adapter<ClubX5Adapter.ClubViewHolder> {

    ArrayList<ClubX5Class> data = new ArrayList<>();

    public ClubX5Adapter(ArrayList<ClubX5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX5Class clickedDataItem = data.get(position);
