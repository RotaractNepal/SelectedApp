...
public class ClubXII3Adapter extends RecyclerView.Adapter<ClubXII3Adapter.ClubViewHolder> {

    ArrayList<ClubXII3Class> data = new ArrayList<>();

    public ClubXII3Adapter(ArrayList<ClubXII3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII3Class clickedDataItem = data.get(position);
