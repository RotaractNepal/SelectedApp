...
public class ClubIX1Adapter extends RecyclerView.Adapter<ClubIX1Adapter.ClubViewHolder> {

    ArrayList<ClubIX1Class> data = new ArrayList<>();

    public ClubIX1Adapter(ArrayList<ClubIX1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX1Class clickedDataItem = data.get(position);
