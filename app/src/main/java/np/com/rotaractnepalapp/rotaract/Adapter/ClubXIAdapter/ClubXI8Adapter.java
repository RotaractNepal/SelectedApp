...
public class ClubXI8Adapter extends RecyclerView.Adapter<ClubXI8Adapter.ClubViewHolder> {

    ArrayList<ClubXI8Class> data = new ArrayList<>();

    public ClubXI8Adapter(ArrayList<ClubXI8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI8Class clickedDataItem = data.get(position);
