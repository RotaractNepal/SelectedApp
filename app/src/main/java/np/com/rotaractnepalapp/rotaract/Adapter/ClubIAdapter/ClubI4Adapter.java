...
public class ClubI4Adapter extends RecyclerView.Adapter<ClubI4Adapter.ClubViewHolder>{

    ArrayList<ClubI4Class> data = new ArrayList<>();

    public ClubI4Adapter(ArrayList<ClubI4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubI4Class clickedDataItem = data.get(position);
