...
public class ClubXI10Adapter extends RecyclerView.Adapter<ClubXI10Adapter.ClubViewHolder> {

    ArrayList<ClubXI10Class> data = new ArrayList<>();

    public ClubXI10Adapter(ArrayList<ClubXI10Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI10Class clickedDataItem = data.get(position);
