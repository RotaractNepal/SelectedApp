...
public class ClubXI7Adapter extends RecyclerView.Adapter<ClubXI7Adapter.ClubViewHolder> {

    ArrayList<ClubXI7Class> data = new ArrayList<>();

    public ClubXI7Adapter(ArrayList<ClubXI7Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI7Class clickedDataItem = data.get(position);
