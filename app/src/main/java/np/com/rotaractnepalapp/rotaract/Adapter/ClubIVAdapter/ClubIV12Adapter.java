...
public class ClubIV12Adapter extends RecyclerView.Adapter<ClubIV12Adapter.ClubViewHolder> {

    ArrayList<ClubIV12Class> data = new ArrayList<>();

    public ClubIV12Adapter(ArrayList<ClubIV12Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV12Class clickedDataItem = data.get(position);
