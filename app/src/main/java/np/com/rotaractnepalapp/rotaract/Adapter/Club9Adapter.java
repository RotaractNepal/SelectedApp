...
public class Club9Adapter extends RecyclerView.Adapter<Club9Adapter.ClubViewHolder> {

    ArrayList<Club9Class> data = new ArrayList<>();

    public Club9Adapter(ArrayList<Club9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final Club9Class clickedDataItem = data.get(position);
