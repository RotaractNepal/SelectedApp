...
public class ClubX2Adapter extends RecyclerView.Adapter<ClubX2Adapter.ClubViewHolder> {

    ArrayList<ClubX2Class> data = new ArrayList<>();

    public ClubX2Adapter(ArrayList<ClubX2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX2Class clickedDataItem = data.get(position);
