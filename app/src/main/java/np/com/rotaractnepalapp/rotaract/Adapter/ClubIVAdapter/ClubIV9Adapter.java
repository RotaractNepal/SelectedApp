...
public class ClubIV9Adapter extends RecyclerView.Adapter<ClubIV9Adapter.ClubViewHolder> {

    ArrayList<ClubIV9Class> data = new ArrayList<>();

    public ClubIV9Adapter(ArrayList<ClubIV9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV9Class clickedDataItem = data.get(position);
