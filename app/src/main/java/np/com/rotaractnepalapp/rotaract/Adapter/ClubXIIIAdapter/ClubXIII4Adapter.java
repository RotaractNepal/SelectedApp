...
public class ClubXIII4Adapter extends RecyclerView.Adapter<ClubXIII4Adapter.ClubViewHolder> {

    ArrayList<ClubXIII4Class> data = new ArrayList<>();

    public ClubXIII4Adapter(ArrayList<ClubXIII4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXIII4Class clickedDataItem = data.get(position);
