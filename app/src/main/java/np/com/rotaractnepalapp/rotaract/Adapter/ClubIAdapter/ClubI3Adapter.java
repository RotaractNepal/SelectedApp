...
public class ClubI3Adapter extends RecyclerView.Adapter<ClubI3Adapter.ClubViewHolder> {

    ArrayList<ClubI3Class> data = new ArrayList<>();

    public ClubI3Adapter(ArrayList<ClubI3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubI3Class clickedDataItem = data.get(position);
