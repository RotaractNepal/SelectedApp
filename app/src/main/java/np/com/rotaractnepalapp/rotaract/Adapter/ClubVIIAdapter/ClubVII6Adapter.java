...
public class ClubVII6Adapter extends RecyclerView.Adapter<ClubVII6Adapter.ClubViewHolder> {


    ArrayList<ClubVII6Class> data = new ArrayList<>();

    public ClubVII6Adapter(ArrayList<ClubVII6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII6Class clickedDataItem = data.get(position);
