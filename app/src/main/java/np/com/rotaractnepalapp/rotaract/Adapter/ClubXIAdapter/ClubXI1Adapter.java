...
public class ClubXI1Adapter extends RecyclerView.Adapter<ClubXI1Adapter.ClubViewHolder> {

    ArrayList<ClubXI1Class> data = new ArrayList<>();

    public ClubXI1Adapter(ArrayList<ClubXI1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI1Class clickedDataItem = data.get(position);
