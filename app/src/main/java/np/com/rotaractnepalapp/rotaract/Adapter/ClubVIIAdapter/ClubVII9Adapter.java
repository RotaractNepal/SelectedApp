...
public class ClubVII9Adapter extends RecyclerView.Adapter<ClubVII9Adapter.ClubViewHolder> {

    ArrayList<ClubVII9Class> data = new ArrayList<>();

    public ClubVII9Adapter(ArrayList<ClubVII9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII9Class clickedDataItem = data.get(position);
