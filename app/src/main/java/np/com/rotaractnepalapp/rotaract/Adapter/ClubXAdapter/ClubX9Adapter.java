...
public class ClubX9Adapter extends RecyclerView.Adapter<ClubX9Adapter.ClubViewHolder> {

    ArrayList<ClubX9Class> data = new ArrayList<>();

    public ClubX9Adapter(ArrayList<ClubX9Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX9Class clickedDataItem = data.get(position);
