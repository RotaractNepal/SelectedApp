...
public class ClubVIII2Adapter extends RecyclerView.Adapter<ClubVIII2Adapter.ClubViewHolder> {

    ArrayList<ClubVIII2Class> data = new ArrayList<>();

    public ClubVIII2Adapter(ArrayList<ClubVIII2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVIII2Class clickedDataItem = data.get(position);
