...
public class ClubVI12Adapter extends RecyclerView.Adapter<ClubVI12Adapter.ClubViewHolder> {

    ArrayList<ClubVI12Class> data = new ArrayList<>();

    public ClubVI12Adapter(ArrayList<ClubVI12Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI12Class clickedDataItem = data.get(position);
