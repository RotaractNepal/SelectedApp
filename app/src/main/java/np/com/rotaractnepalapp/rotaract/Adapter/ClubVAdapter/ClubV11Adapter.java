...
public class ClubV11Adapter extends RecyclerView.Adapter<ClubV11Adapter.ClubViewHolder> {

    ArrayList<ClubV11Class> data = new ArrayList<>();

    public ClubV11Adapter(ArrayList<ClubV11Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV11Class clickedDataItem = data.get(position);
