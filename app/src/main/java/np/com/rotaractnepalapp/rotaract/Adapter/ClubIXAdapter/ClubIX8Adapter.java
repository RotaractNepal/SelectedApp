...
public class ClubIX8Adapter extends RecyclerView.Adapter<ClubIX8Adapter.ClubViewHolder> {

    ArrayList<ClubIX8Class> data = new ArrayList<>();

    public ClubIX8Adapter(ArrayList<ClubIX8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX8Class clickedDataItem = data.get(position);
