...
public class ClubV4Adapter extends RecyclerView.Adapter<ClubV4Adapter.ClubViewHolder> {

    ArrayList<ClubV4Class> data = new ArrayList<>();

    public ClubV4Adapter(ArrayList<ClubV4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV4Class clickedDataItem = data.get(position);
