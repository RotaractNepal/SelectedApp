...
public class DistrictEventsAdapter extends RecyclerView.Adapter<DistrictEventsAdapter.EventsViewHolder> {

    ArrayList<DistrictEventsClass> data = new ArrayList<>();

    public DistrictEventsAdapter(ArrayList<DistrictEventsClass> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final DistrictEventsClass clickedDataItem = data.get(position);
