...
public class ClubV5Adapter extends RecyclerView.Adapter<ClubV5Adapter.ClubViewHolder> {

    ArrayList<ClubV5Class> data = new ArrayList<>();

    public ClubV5Adapter(ArrayList<ClubV5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV5Class clickedDataItem = data.get(position);
