...
public class ClubVI10Adapter extends RecyclerView.Adapter<ClubVI10Adapter.ClubViewHolder> {

    ArrayList<ClubVI10Class> data = new ArrayList<>();

    public ClubVI10Adapter(ArrayList<ClubVI10Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI10Class clickedDataItem = data.get(position);
