...
public class ClubXII10Class {
    ...
    public ClubXII10Class() {
    }

    public ClubXII10Class(int images, String title, int bimages, String name, String ridno, String call, String email) {
        this.images = images;
        this.title = title;
