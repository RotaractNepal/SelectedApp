...
public class ClubV1Adapter extends RecyclerView.Adapter<ClubV1Adapter.ClubViewHolder> {

    ArrayList<ClubV1Class> data = new ArrayList<>();

    public ClubV1Adapter(ArrayList<ClubV1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV1Class clickedDataItem = data.get(position);
