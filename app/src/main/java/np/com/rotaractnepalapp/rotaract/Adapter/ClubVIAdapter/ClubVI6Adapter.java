...
public class ClubVI6Adapter extends RecyclerView.Adapter<ClubVI6Adapter.ClubViewHolder> {

    ArrayList<ClubVI6Class> data = new ArrayList<>();

    public ClubVI6Adapter(ArrayList<ClubVI6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVI6Class clickedDataItem = data.get(position);
