...
public class ClubXI3Adapter extends RecyclerView.Adapter<ClubXI3Adapter.ClubViewHolder> {

    ArrayList<ClubXI3Class> data = new ArrayList<>();

    public ClubXI3Adapter(ArrayList<ClubXI3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXI3Class clickedDataItem = data.get(position);
