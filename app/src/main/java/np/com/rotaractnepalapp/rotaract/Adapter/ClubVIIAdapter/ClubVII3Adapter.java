...
public class ClubVII3Adapter extends RecyclerView.Adapter<ClubVII3Adapter.ClubViewHolder> {

    ArrayList<ClubVII3Class> data = new ArrayList<>();

    public ClubVII3Adapter(ArrayList<ClubVII3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVII3Class clickedDataItem = data.get(position);
