...
public class ClubXII6Adapter extends RecyclerView.Adapter<ClubXII6Adapter.ClubViewHolder> {

    ArrayList<ClubXII6Class> data = new ArrayList<>();

    public ClubXII6Adapter(ArrayList<ClubXII6Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII6Class clickedDataItem = data.get(position);
