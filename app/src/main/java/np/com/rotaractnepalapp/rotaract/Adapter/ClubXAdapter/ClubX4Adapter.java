...
public class ClubX4Adapter extends RecyclerView.Adapter<ClubX4Adapter.ClubViewHolder> {

    ArrayList<ClubX4Class> data = new ArrayList<>();

    public ClubX4Adapter(ArrayList<ClubX4Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX4Class clickedDataItem = data.get(position);
