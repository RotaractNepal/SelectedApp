...
public class ClubXII5Adapter extends RecyclerView.Adapter<ClubXII5Adapter.ClubViewHolder> {

    ArrayList<ClubXII5Class> data = new ArrayList<>();

    public ClubXII5Adapter(ArrayList<ClubXII5Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII5Class clickedDataItem = data.get(position);
