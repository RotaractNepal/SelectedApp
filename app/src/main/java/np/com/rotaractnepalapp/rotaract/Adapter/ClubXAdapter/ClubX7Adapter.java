...
public class ClubX7Adapter extends RecyclerView.Adapter<ClubX7Adapter.ClubViewHolder> {

    ArrayList<ClubX7Class> data = new ArrayList<>();

    public ClubX7Adapter(ArrayList<ClubX7Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubX7Class clickedDataItem = data.get(position);
