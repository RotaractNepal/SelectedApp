...
public class ClubXIII2Adapter extends RecyclerView.Adapter<ClubXIII2Adapter.ClubViewHolder> {

    ArrayList<ClubXIII2Class> data = new ArrayList<>();

    public ClubXIII2Adapter(ArrayList<ClubXIII2Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXIII2Class clickedDataItem = data.get(position);
