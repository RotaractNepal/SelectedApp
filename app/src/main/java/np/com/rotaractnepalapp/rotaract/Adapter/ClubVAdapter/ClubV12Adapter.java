...
public class ClubV12Adapter extends RecyclerView.Adapter<ClubV12Adapter.ClubViewHolder> {

    ArrayList<ClubV12Class> data = new ArrayList<>();

    public ClubV12Adapter(ArrayList<ClubV12Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubV12Class clickedDataItem = data.get(position);
