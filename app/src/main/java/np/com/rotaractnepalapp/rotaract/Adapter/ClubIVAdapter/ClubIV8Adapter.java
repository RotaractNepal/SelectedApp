...
public class ClubIV8Adapter extends RecyclerView.Adapter<ClubIV8Adapter.ClubViewHolder> {

    ArrayList<ClubIV8Class> data = new ArrayList<>();

    public ClubIV8Adapter(ArrayList<ClubIV8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIV8Class clickedDataItem = data.get(position);
