...
public class ClubXII7Adapter extends RecyclerView.Adapter<ClubXII7Adapter.ClubViewHolder> {

    ArrayList<ClubXII7Class> data = new ArrayList<>();

    public ClubXII7Adapter(ArrayList<ClubXII7Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII7Class clickedDataItem = data.get(position);
