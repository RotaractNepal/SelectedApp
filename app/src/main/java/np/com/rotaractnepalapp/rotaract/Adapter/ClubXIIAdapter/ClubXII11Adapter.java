...
public class ClubXII11Adapter extends RecyclerView.Adapter<ClubXII11Adapter.ClubViewHolder> {

    ArrayList<ClubXII11Class> data = new ArrayList<>();

    public ClubXII11Adapter(ArrayList<ClubXII11Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII11Class clickedDataItem = data.get(position);
