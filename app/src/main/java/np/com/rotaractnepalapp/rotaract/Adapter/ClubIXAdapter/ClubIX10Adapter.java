...
public class ClubIX10Adapter extends RecyclerView.Adapter<ClubIX10Adapter.ClubViewHolder>{

    ArrayList<ClubIX10Class> data = new ArrayList<>();

    public ClubIX10Adapter(ArrayList<ClubIX10Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIX10Class clickedDataItem = data.get(position);
