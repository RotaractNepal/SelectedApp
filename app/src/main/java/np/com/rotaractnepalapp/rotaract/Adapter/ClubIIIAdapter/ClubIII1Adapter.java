...
public class ClubIII1Adapter extends RecyclerView.Adapter<ClubIII1Adapter.ClubViewHolder> {

    ArrayList<ClubIII1Class> data = new ArrayList<>();

    public ClubIII1Adapter(ArrayList<ClubIII1Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubIII1Class clickedDataItem = data.get(position);
