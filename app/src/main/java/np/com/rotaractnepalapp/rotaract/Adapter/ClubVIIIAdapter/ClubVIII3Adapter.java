...
public class ClubVIII3Adapter extends RecyclerView.Adapter<ClubVIII3Adapter.ClubViewHolder> {

    ArrayList<ClubVIII3Class> data = new ArrayList<>();

    public ClubVIII3Adapter(ArrayList<ClubVIII3Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubVIII3Class clickedDataItem = data.get(position);
