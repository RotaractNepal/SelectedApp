...
public class ClubXII8Adapter extends RecyclerView.Adapter<ClubXII8Adapter.ClubViewHolder> {

    ArrayList<ClubXII8Class> data = new ArrayList<>();

    public ClubXII8Adapter(ArrayList<ClubXII8Class> data) {
        this.data = data;
    }
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION){
                        final ClubXII8Class clickedDataItem = data.get(position);
